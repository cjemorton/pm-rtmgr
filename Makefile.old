# This Makefile is for the Rtmgr::Gen::Db extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Rtmgr/Gen/Db.pm]
...
#     VERSION_FROM => q[lib/Rtmgr/Gen/Db.pm]
#     clean => { FILES=>q[Rtmgr-Gen-Db-*] }
...
MAKEMAKER   = /home/clem/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.44
MM_REVISION = 74400
...
MAKE = make
FULLEXT = Rtmgr/Gen/Db
BASEEXT = Db
PARENT_NAME = Rtmgr::Gen
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Rtmgr/Gen/Db.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Rtmgr/Gen
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Rtmgr/Gen
...
TO_INST_PM = lib/Rtmgr/Gen/Db.pm
...
DISTNAME = Rtmgr-Gen-Db
DISTVNAME = Rtmgr-Gen-Db-0.01
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3SECTION) --perm_rw=$(PERM_RW) -u \
	  lib/Rtmgr/Gen/Db.pm $(INST_MAN3DIR)/Rtmgr::Gen::Db.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Connect to rTorrent/ruTorrent installation and get a list of torrents, storing them to a database.!'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Clem Morton <clem@cpan.org>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Rtmgr-Gen-Db' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Connect to rTorrent/ruTorrent installation and get a list of torrents, storing them to a database.!",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Rtmgr-Gen-Db",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Rtmgr-Gen-Db" VERSION="0.01">' > Rtmgr-Gen-Db.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Connect to rTorrent/ruTorrent installation and get a list of torrents, storing them to a database.!</ABSTRACT>' >> Rtmgr-Gen-Db.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Clem Morton &lt;clem@cpan.org&gt;</AUTHOR>' >> Rtmgr-Gen-Db.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> Rtmgr-Gen-Db.ppd
	$(NOECHO) $(ECHO) '        <PERLCORE VERSION="5,006,0,0" />' >> Rtmgr-Gen-Db.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.28" />' >> Rtmgr-Gen-Db.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> Rtmgr-Gen-Db.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> Rtmgr-Gen-Db.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> Rtmgr-Gen-Db.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/Rtmgr/Gen/Db.pm' 'blib/lib/Rtmgr/Gen/Db.pm' 
