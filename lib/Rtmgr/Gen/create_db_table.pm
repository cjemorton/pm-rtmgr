...
sub create_db_table {
my $sb_stmt = qq(CREATE TABLE SEEDBOX (ID TEXT PRIMARY KEY NOT NULL, BLANK TEXT NOT NULL, SCENE TEXT NOT NULL, TRACKER TEXT NOT NULL, NAME TEXT NOT NULL););

my $cred = qq(CREATE TABLE CREDENTIALS (ID TEXT PRIMARY KEY NOT NULL, SEEDBOX_UN TEXT NOT NULL, SEEDBOX_PW TEXT NOT NULL, SEEDBOX_HN TEXT NOT NULL, SEEDBOX_PR TEXT NOT NULL, SEEDBOX_EP TEXT NOT NULL, DATABASE TEXT NOT NULL, SRRDB_UN TEXT NOT NULL, SRRDB_PW TEXT NOT NULL););


run_sqldb_query($_[0], $sb_stmt, $cred);
